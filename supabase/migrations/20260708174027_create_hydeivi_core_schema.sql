...
create table if not exists public.athlete_availability (
  ...
  can_double_session boolean not null default false,
...
create table if not exists public.athlete_equipment (
  id uuid primary key default gen_random_uuid(),
  user_id uuid not null references auth.users(id) on delete cascade,
  ski_erg boolean not null default false,
  row_erg boolean not null default false,
  bike_erg boolean not null default false,
  assault_bike boolean not null default false,
  sled boolean not null default false,
  wall_ball boolean not null default false,
  sandbag boolean not null default false,
  kettlebells boolean not null default false,
  dumbbells boolean not null default false,
  barbell_and_plates boolean not null default false,
  treadmill boolean not null default false,
  running_space boolean not null default false,
  plyo_box boolean not null default false,
  created_at timestamptz not null default now(),
  updated_at timestamptz not null default now(),
  unique (user_id)
);
...
create table if not exists public.nutrition_preferences (
  ...
  meal_timing text not null default '',
...
create table if not exists public.daily_readiness (
  ...
  date date not null,
  sleep_hours numeric,
  sleep_quality_1_to_5 numeric,
  stress_1_to_5 numeric,
  fatigue_1_to_5 numeric,
  muscle_soreness_1_to_5 numeric,
  leg_soreness_1_to_5 numeric,
  upper_soreness_1_to_5 numeric,
  motivation_1_to_5 numeric,
  hydration_1_to_5 numeric,
  pain_0_to_10 numeric,
